...
echo.
call :_color2 %_White% "              " %_Green% "[1] Activate - Windows"
echo.
...
if not defined _tskinstalled if not defined _oldtsk echo.              [2] Install Auto-Renewal
echo.              [3] Uninstall
echo.              _______________________________________________  
echo.
if %_Debug%==0 (
echo.              [4] Enable Debug Mode         [No]
) else (
...
if %_el%==8 exit /b
if %_el%==4 (if %_Debug%==0 (set _Debug=1) else (set _Debug=0)) &goto _KMS_Menu
if %_el%==3 call:_Complete_Uninstall&cls&goto _KMS_Menu
if %_el%==2 set ActTask=&call:RenTask&goto _KMS_Menu
